<!-- @migration-task Error while migrating Svelte code: can't migrate `let models = ["mistral", "mistral:q2_k", "codellama", "codellama:13b"];` to `$state` because there's a variable named state.
